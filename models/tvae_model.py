...
class TVAE(BaseModel):
    def __init__(self, ntoken: int, d_model: int = 256, z_dim: int = 128, nhead_encoder: int = 8, nhead_decoder: int = 8, d_hid: int = 1024, nlayers: int = 1, dropout: float = 0.1, use_gru=False, **kwargs):
        self.ntoken = ntoken
